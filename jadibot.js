...
const client = makeWaSocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["Yuuzellbotz server", "Dekstop", "3.0"]})
console.log(color('[ SC BY sanzzx ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : 4K-Sanzz\n➸ Creator : ZIRO\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : 4K-Sanzz OFFICIAL`\n➸ My Instagram : @fhl.dx17\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/sanzzx\n\nThanks\n', 'red'))
